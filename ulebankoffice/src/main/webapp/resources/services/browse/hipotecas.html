...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Hipotecas ULe-Bank.">
        <meta name="keywords" content="ULe-Bank, hipotecas, inversa">
    ...
    <body>
        ...
        <header class="general-class">
            <div class="container header-content">
                <a href="/resources/index.html">ULEBANK</a>
        ...
        <main class="general-class">
            ...
            <div class="container">
                ...
                <div class="col-md-3 hidden-sm hidden-xs browse-root">
                    <ul>
                        <a href="prestamos.html"><li class="no-active"><span class="category">Préstamos</span><span class="glyphicon glyphicon-chevron-right arrow"></span></li></a>
                        <a href="#"><li class="active"><span class="category">Hipotecas</span><span class="glyphicon glyphicon-chevron-right arrow"></span></li></a>
                ...
                <div class="col-md-9 col-sm-12 browse-results">
                    ...
                    <div class="col-md-6 results">
                        ...
                        <ul>
                            <a href="/hipoteca-inversa.htm">
                                <li>
                                    <h4>Hipoteca inversa</h4>
                                    <p>Para mayores de 65 años o dependientes. Se hipoteca la vivienda sin 
                                    perder la titularidad, hasta el fallecimiento de los titulares.</p>
                                </li>
                            </a>
                        </ul>
                    </div>
            ...
            <div class="container footer-container">
                ...
                <div class="row legal">
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Última actualización - 21 de Marzo de 2016</p>
