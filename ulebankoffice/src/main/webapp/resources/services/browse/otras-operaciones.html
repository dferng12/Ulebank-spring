...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Otras operaciones ULe-Bank.">
            ...
            <div class="container">
                ...
                <div class="col-md-3 hidden-sm hidden-xs browse-root">
                    <ul>
                        ...
                        <a href="#"><li class="active"><span class="category">Otras operaciones</span><span class="glyphicon glyphicon-chevron-right arrow"></span></li></a>
                    </ul>
                </div>
                ...
                <div class="col-md-9 col-sm-12 browse-results">
                    ...
                    <div class="col-md-6 results">
                        ...
                        <ul>
                            <a href="/descuentos.htm">
                                <li>
                                    <h4>Descuentos</h4>
                                    <p>Simulación de anticipo a clientes (denominado efectivo).</p>
                                </li>
                            </a>
                        </ul>
                    </div>
