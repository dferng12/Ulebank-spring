...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Leasing ULe-Bank.">
        <meta name="keywords" content="ULe-Bank, leasing, arrendamiento, financiero">
            ...
            <div class="container">
                ...
                <div class="col-md-3 hidden-sm hidden-xs browse-root">
                    <ul>
                        ...
                        <a href="#"><li class="active"><span class="category">Leasing</span><span class="glyphicon glyphicon-chevron-right arrow"></span></li></a>
                ...
                <div class="col-md-9 col-sm-12 browse-results">
                    ...
                    <div class="col-md-6 results">
                        ...
                        <ul>
                            <a href="/arrendamiento-financiero.htm">
                                <li>
                                    <h4>Arrendamiento financiero</h4>
                                    <p>Contrato mediante el cual la empresa arrendadora entrega un activo a la persona 
                                    que lo solicita a cambio de un pago periodico.</p>
                                </li>
                            </a>
                        </ul>
                    </div>
