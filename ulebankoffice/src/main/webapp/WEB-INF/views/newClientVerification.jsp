...
<link href="resources/template/css/custom.css" rel="stylesheet"
	type="text/css" />
        ...
        <title><spring:message code="label.newClient" /></title>
				...
				<div class="container">
					<div class="row text-center intro-title">
						...
						<ul class="page-breadcrumb">
							...
							<li><a href="/o"><spring:message
										code="label.office" /></a><i
								class="fa fa-angle-double-right"></i></li>
							<li><span><spring:message code="label.newClient" /></span></li>
						</ul>
					</div>
				</div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-2">
						<div class="row">
							<h1>
								<spring:message code="label.clientSuccess" />
							</h1>
						</div>
						<div class="row">
							<a href="/o" class="button mt-20"> <span><spring:message
										code="label.returnToOffice" /> </span> <i class="fa fa-list-ol"></i></a>
						</div>
						<div class="row">
							<a href="/o/logout" class="button mt-20"> <span><spring:message
